...
public class Golfball extends Sprite implements MouseListener, MouseMotionListener {
  ...
  public void mouseMoved(MouseEvent e) {
    ...
    deltaX = (int) calcDeltaX(e.getX(), getX() + (getWidth() / 2));
    deltaY = (int) calcDeltaY(e.getY(), getY() + getHeight());
  ...
  double calcPower(int X2, int Y2) {
     ...
     */
    double output = Math.sqrt(Math.pow((getX() / 2) - X2, 2) + Math.pow((getY() / 2) - Y2, 2))
